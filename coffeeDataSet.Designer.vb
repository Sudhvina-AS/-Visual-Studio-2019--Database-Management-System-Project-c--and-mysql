...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("coffeeDataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class coffeeDataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As coffeeDataSet = CType(MyBase.Clone,coffeeDataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "coffeeDataSet"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/coffeeDataSet.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As coffeeDataSet = New coffeeDataSet()
    ...
    Partial Public Class custDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddcustRow(ByVal name As String, ByVal addr As String, ByVal city As String, ByVal contact As String, ByVal email As String) As custRow
            Dim rowcustRow As custRow = CType(Me.NewRow,custRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, name, addr, city, contact, email}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindById(ByVal Id As Integer) As custRow
            Return CType(Me.Rows.Find(New Object() {Id}),custRow)
        End Function
    ...
    Partial Public Class custRow
        ...
        Public Function IsaddrNull() As Boolean
            Return Me.IsNull(Me.tablecust.addrColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetaddrNull()
            Me(Me.tablecust.addrColumn) = Global.System.Convert.DBNull
        End Sub
        ...
        Public Function IscontactNull() As Boolean
            Return Me.IsNull(Me.tablecust.contactColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetcontactNull()
            Me(Me.tablecust.contactColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function IsemailNull() As Boolean
            Return Me.IsNull(Me.tablecust.emailColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetemailNull()
            Me(Me.tablecust.emailColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace coffeeDataSetTableAdapters
    ...
    Partial Public Class custTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[cust] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND "& _ 
                "[name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_addr = 1 AND [addr] "& _ 
                "IS NULL) OR ([addr] = @Original_addr)) AND ((@IsNull_city = 1 AND [city] IS NULL"& _ 
                ") OR ([city] = @Original_city)) AND ((@IsNull_contact = 1 AND [contact] IS NULL)"& _ 
                " OR ([contact] = @Original_contact)) AND ((@IsNull_email = 1 AND [email] IS NULL"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[cust] ([name], [addr], [city], [contact], [email]) VALUES (@na"& _ 
                "me, @addr, @city, @contact, @email);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, name, addr, city, contact, emai"& _ 
                "l FROM cust WHERE (Id = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[cust] SET [name] = @name, [addr] = @addr, [city] = @city, [contact]"& _ 
                " = @contact, [email] = @email WHERE (([Id] = @Original_Id) AND ((@IsNull_name = "& _ 
                "1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_addr = 1 AND ["& _ 
                "addr] IS NULL) OR ([addr] = @Original_addr)) AND ((@IsNull_city = 1 AND [city] I"& _ 
                "S NULL) OR ([city] = @Original_city)) AND ((@IsNull_contact = 1 AND [contact] IS"& _ 
                " NULL) OR ([contact] = @Original_contact)) AND ((@IsNull_email = 1 AND [email] I"& _ 
                "S NULL) OR ([email] = @Original_email)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, name, addr, city, contact,"& _ 
                " email FROM cust WHERE (Id = @Id)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, name, addr, city, contact, email FROM dbo.cust"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As coffeeDataSet.custDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As coffeeDataSet.custDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As coffeeDataSet.custDataTable = New coffeeDataSet.custDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As coffeeDataSet.custDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As coffeeDataSet) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_name As String, ByVal Original_addr As String, ByVal Original_city As String, ByVal Original_contact As String, ByVal Original_email As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal name As String, ByVal addr As String, ByVal city As String, ByVal contact As String, ByVal email As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal name As String, ByVal addr As String, ByVal city As String, ByVal contact As String, ByVal email As String, ByVal Original_Id As Integer, ByVal Original_name As String, ByVal Original_addr As String, ByVal Original_city As String, ByVal Original_contact As String, ByVal Original_email As String, ByVal Id As Integer) As Integer
            If (name Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_addr,String)
            End If
            If (Original_city Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal name As String, ByVal addr As String, ByVal city As String, ByVal contact As String, ByVal email As String, ByVal Original_Id As Integer, ByVal Original_name As String, ByVal Original_addr As String, ByVal Original_city As String, ByVal Original_contact As String, ByVal Original_email As String) As Integer
            Return Me.Update(name, addr, city, contact, email, Original_Id, Original_name, Original_addr, Original_city, Original_contact, Original_email, Original_Id)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As coffeeDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As coffeeDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._custTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As coffeeDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._custTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As coffeeDataSet) As Integer
